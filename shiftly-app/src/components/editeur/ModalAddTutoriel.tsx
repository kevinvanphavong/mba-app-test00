...
export default function ModalAddTutoriel({ open, editTutoriel, zones, onClose, onSave }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end">
      ...
      <div
        className="relative bg-surface border-t border-border rounded-t-[24px] px-5 pt-5 max-w-[720px] w-full mx-auto max-h-[90vh] overflow-y-auto flex flex-col gap-4"

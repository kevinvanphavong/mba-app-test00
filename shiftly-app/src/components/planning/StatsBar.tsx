...
export default function StatsBar({ stats, zones, alertCount, showAlerts, onToggleAlerts }: StatsBarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 border-t border-[var(--border)] bg-[var(--surface)] px-4 py-3 tablet:gap-6 tablet:px-6 tablet:py-3.5">

      {/* Métriques */}
      <div className="flex flex-wrap items-center gap-3 tablet:gap-6">
      ...
      <button
        ...
        className={`flex min-h-[44px] items-center gap-2 rounded-lg border px-3 py-2 text-xs font-semibold transition-colors tablet:min-h-0 tablet:py-1.5 ${
          showAlerts

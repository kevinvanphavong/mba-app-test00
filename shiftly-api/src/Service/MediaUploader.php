    ...
    public function upload(
        ...
        if (!$file->isValid()) {
            $message = match ($file->getError()) {
                UPLOAD_ERR_INI_SIZE, UPLOAD_ERR_FORM_SIZE => 'Fichier trop volumineux pour le serveur (limite PHP dépassée).',
                UPLOAD_ERR_PARTIAL => 'Upload interrompu, fichier incomplet. Réessayez.',

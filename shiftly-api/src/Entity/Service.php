...
class Service
{
    ...
    public function setDate(?\DateTimeImmutable $d): static
    {
        $this->date = $d;
    ...
    public function setHeureDebut(?\DateTimeImmutable $v): static
    {
        $this->heureDebut = $v;
    ...
    public function setHeureFin(?\DateTimeImmutable $v): static
    {
        $this->heureFin = $v;
    ...
    {
        return $this->tauxCompletion;
    }

    public function setTauxCompletion(float $v): static
    {
        $this->tauxCompletion = $v;
    ...
    public function getMissionsSnapshot(): ?array
    {
        return $this->missionsSnapshot;
    }

    public function setMissionsSnapshot(?array $v): static
    {
        $this->missionsSnapshot = $v;
